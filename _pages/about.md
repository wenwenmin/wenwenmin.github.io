...
- 闵老师长期从事人工智能算法（深度扩散模型、Transformer模型、图神经网络、对比学习、基于掩码机制的自监督学习、单细胞/空转大模型、矩阵张量优化等）及其在生物医学大数据中的应用研究。
